...
ARG BILLING_PRICE_PER_NUMBER_CENTS
ENV BILLING_PRICE_PER_NUMBER_CENTS=$BILLING_PRICE_PER_NUMBER_CENTS
ARG BULL_BOARD_SECRET
ENV BULL_BOARD_SECRET=$BULL_BOARD_SECRET
ARG CLOUD_ADVANCED_ALERTS
ENV CLOUD_ADVANCED_ALERTS=$CLOUD_ADVANCED_ALERTS
ARG CLOUD_BILLING
ENV CLOUD_BILLING=$CLOUD_BILLING
ARG CLOUD_EXPONENTIAL_RETRY
ENV CLOUD_EXPONENTIAL_RETRY=$CLOUD_EXPONENTIAL_RETRY
ARG DATABASE_URL
...
ARG PAGUE_DEV_API_KEY
ENV PAGUE_DEV_API_KEY=$PAGUE_DEV_API_KEY
ARG PAGUE_DEV_BASE_URL
ENV PAGUE_DEV_BASE_URL=$PAGUE_DEV_BASE_URL
ARG PAGUE_DEV_WEBHOOK_SECRET
ENV PAGUE_DEV_WEBHOOK_SECRET=$PAGUE_DEV_WEBHOOK_SECRET
ARG PING_TIMEOUT_MS
