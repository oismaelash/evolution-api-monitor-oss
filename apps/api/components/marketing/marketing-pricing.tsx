      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-4 lg:gap-x-8 lg:gap-y-0">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`rounded-3xl p-8 ring-1 xl:p-10 flex flex-col bg-[var(--color-surface)] ${
                plan.highlight
            ...
            >
              ...
              <a
                href={plan.href}
                className={`mt-auto block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                  plan.highlight
                    ? 'bg-[var(--color-accent)] text-white hover:bg-[var(--color-accent)]/80 focus-visible:outline-[var(--color-accent)]'
                    : 'bg-[var(--color-border)] text-[var(--color-text-primary)] hover:bg-[var(--color-border)]/80 focus-visible:outline-[var(--color-border)]'
                }`}
              >
                {plan.cta}
              </a>
